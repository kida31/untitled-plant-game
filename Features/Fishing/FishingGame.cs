...
public partial class FishingGame : Node2D
{
	...
	public override void _Ready()
	{
		...
		_hookedFishSpeedModifier.Text = $"{untitledplantgame.Fishing.Fish.HookSpeedMod}";
		_hookedFishSpeedModifier.TextChanged += (text) => untitledplantgame.Fishing.Fish.HookSpeedMod = float.Parse(text);
